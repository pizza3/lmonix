...
export default class Texture extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Title id="texture">Texture</Title>
        <Trigger
          action={["click"]}
          popup={
            <TextureDropdown
              ...
              checkForTexture={this.checkForTexture}
          ...
          getPopupContainer={() => document.getElementById("texture")}
        >
          <Input>{isTexture ? content : "Add Texture"}</Input>
        </Trigger>
        {isTexture ? (
          <Delete
