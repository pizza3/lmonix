...
import { TrackballControls, TransformControls, PointerLockControls } from './ThreeLibManager'; // eslint-disable-next-line
...
export default class SceneRenderer extends Component{
    ...
    initScene = () => {
        ...
        this.transformControls.addEventListener("change", function(){this.renderScene()}.bind(this));
    ...
    render(){
        return(
            <SceneRendererContainer id="SceneRenderer" onMouseLeave={this.handleLeave} onMouseEnter={this.handleOver} >
